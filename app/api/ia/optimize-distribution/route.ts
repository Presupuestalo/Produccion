...
2. MANTÉN INTACTOS: todas las paredes, puertas, ventanas y tabiques exactamente como están
3. IDENTIFICA cada habitación por su forma y ubicación (dormitorio, salón, cocina, baño, etc.)
4. AÑADE mobiliario lógico y realista para cada tipo de habitación:
...
3. ANÁLISIS: identifica el tipo de cada habitación por su ubicación y forma
