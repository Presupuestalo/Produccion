...
export async function POST(request: Request) {
  try {
    ...
    const createTableSQL = `
      ...
      -- Crear política para que los usuarios solo puedan ver sus propias citas
      ...
      -- Crear política para que los usuarios solo puedan insertar sus propias citas
      ...
      -- Crear política para que los usuarios solo puedan actualizar sus propias citas
      ...
      -- Crear política para que los usuarios solo puedan eliminar sus propias citas
