-- Eliminar dinámicamente todas las políticas RLS existentes
DO $$
DECLARE
    r RECORD;
BEGIN
...
(gen_random_uuid(), 'DERRIBO', 'Trabajos de demolición y retirada', 'Hammer', 1, true),
...
-- Insertar precios maestros - DERRIBOS
...
(gen_random_uuid(), '01-D-01', (SELECT id FROM price_categories WHERE name = 'DERRIBO'), 'TABIQUES DERRIBO', 'Tirar tabique existente, incluyendo mano de obra y desescombro a punto autorizado.', 'm²', 12.10, 5.18, 0, 0, false, NULL::uuid),
(gen_random_uuid(), '01-D-02', (SELECT id FROM price_categories WHERE name = 'DERRIBO'), 'PICADO ALICATADO PAREDES', 'Picado de paredes para la retirada del alicatado o revestimiento cerámico existente en parámetros verticales.', 'm²', 10.08, 4.32, 0, 0, false, NULL::uuid),
(gen_random_uuid(), '01-D-03', (SELECT id FROM price_categories WHERE name = 'DERRIBO'), 'PICADO SUELOS', 'Picado de suelo y posterior desescombro.', 'm²', 14.82, 6.35, 0, 0, false, NULL::uuid),
(gen_random_uuid(), '01-D-04', (SELECT id FROM price_categories WHERE name = 'DERRIBO'), 'RETIRADA DE FALSO TECHO', 'Retirada y desescombro de falso techo de escayola o pladur.', 'm²', 10.08, 4.32, 0, 0, false, NULL::uuid),
(gen_random_uuid(), '01-D-05', (SELECT id FROM price_categories WHERE name = 'DERRIBO'), 'RETIRADA DE MOLDURAS', 'Retirada de molduras de escayola o madera en el perímetro de techos.', 'ml', 1.01, 0.43, 0, 0, false, NULL::uuid),
(gen_random_uuid(), '01-D-06', (SELECT id FROM price_categories WHERE name = 'DERRIBO'), 'RETIRADA DE TARIMA MADERA Y RASTRELES', 'Desmontaje de tarima flotante o suelo de madera incluyendo los rastreles inferiores.', 'm²', 6.05, 2.59, 0, 0, false, NULL::uuid),
(gen_random_uuid(), '01-D-07', (SELECT id FROM price_categories WHERE name = 'DERRIBO'), 'RETIRADA DE RODAPIE DE MADERA', 'Retirada de rodapié de madera y acopio para desescombro.', 'ml', 1.81, 0.78, 0, 0, false, NULL::uuid),
(gen_random_uuid(), '01-D-08', (SELECT id FROM price_categories WHERE name = 'DERRIBO'), 'RETIRADA DE RODAPIE CERÁMICO', 'Retirada de rodapié cerámico o de azulejo.', 'ml', 3.93, 1.69, 0, 0, false, NULL::uuid),
(gen_random_uuid(), '01-D-09', (SELECT id FROM price_categories WHERE name = 'DERRIBO'), 'CONTENEDOR DESESCOMBRO', 'Suministro, colocación y retirada de contenedor de residuos de obra a vertedero autorizado.', 'Ud', 100.80, 403.20, 0, 0, false, NULL::uuid),
(gen_random_uuid(), '01-D-10', (SELECT id FROM price_categories WHERE name = 'DERRIBO'), 'HR BAJADA DE ESCOMBROS', 'Mano de obra por hora dedicada al acarreo y bajada de escombros.', 'H', 18.00, 0, 0, 0, false, NULL::uuid),
(gen_random_uuid(), '01-D-11', (SELECT id FROM price_categories WHERE name = 'DERRIBO'), 'ANULACIÓN INSTALACIÓN ELÉCTRICA/FONTANERÍA', 'Desconexión y anulación de líneas antiguas.', 'Ud', 120.96, 51.84, 0, 0, false, NULL::uuid),
(gen_random_uuid(), '01-D-12', (SELECT id FROM price_categories WHERE name = 'DERRIBO'), 'DESMONTAJE HOJAS PUERTAS Y RETIRADA', 'Desmontaje de hoja de puerta existente y posterior retirada.', 'Ud', 20.16, 8.64, 0, 0, false, NULL::uuid),
(gen_random_uuid(), '01-D-13', (SELECT id FROM price_categories WHERE name = 'DERRIBO'), 'PREPARACIÓN PAREDES (Gotelé/Papel)', 'Rascado de paredes para eliminación de gotelé, papel pintado o materiales blandos.', 'm²', 2.52, 1.08, 0, 0, false, NULL::uuid),
(gen_random_uuid(), '01-D-14', (SELECT id FROM price_categories WHERE name = 'DERRIBO'), 'RETIRADA ELEMENTOS BAÑO (Sanitarios)', 'Desmontaje y retirada de inodoro, bidé, lavabo o bañera.', 'Ud', 120.96, 51.84, 0, 0, false, NULL::uuid),
(gen_random_uuid(), '01-D-15', (SELECT id FROM price_categories WHERE name = 'DERRIBO'), 'RETIRADA DE MOBILIARIO COCINA', 'Desmontaje de muebles altos y bajos de cocina existentes.', 'Ud', 241.92, 103.68, 0, 0, false, NULL::uuid),
(gen_random_uuid(), '01-D-16', (SELECT id FROM price_categories WHERE name = 'DERRIBO'), 'RETIRADA DE ARMARIOS Y RESTO MOBILIARIO', 'Desmontaje de armarios empotrados o mobiliario fijo a medida.', 'Ud', 360.86, 154.66, 0, 0, false, NULL::uuid);

-- Insertar precios maestros - ALBAÑILERÍA
INSERT INTO price_master (id, code, category_id, subcategory, description, unit, labor_cost, material_cost, equipment_cost, other_cost, is_custom, user_id) VALUES
...
-- Insertar precios maestros - FONTANERÍA
INSERT INTO price_master (id, code, category_id, subcategory, description, unit, labor_cost, material_cost, equipment_cost, other_cost, is_custom, user_id) VALUES
...
-- Insertar precios maestros - CARPINTERÍA
INSERT INTO price_master (id, code, category_id, subcategory, description, unit, labor_cost, material_cost, equipment_cost, other_cost, is_custom, user_id) VALUES
(gen_random_uuid(), '04-C-01', (SELECT id FROM price_categories WHERE name = 'CARPINTERIA'), 'NIVELACIÓN DE SUELOS CON TABLERO Y RASTREL', 'Colocación de tablero sobre rastreles para nivelar un suelo antes de instalar tarima.', 'm²', 20.16, 30.24, 0, 0, false, NULL::uuid),
...
-- Insertar precios maestros - ELECTRICIDAD
INSERT INTO price_master (id, code, category_id, subcategory, description, unit, labor_cost, material_cost, equipment_cost, other_cost, is_custom, user_id) VALUES
...
-- Insertar precios maestros - CALEFACCIÓN
INSERT INTO price_master (id, code, category_id, subcategory, description, unit, labor_cost, material_cost, equipment_cost, other_cost, is_custom, user_id) VALUES
...
-- Insertar precios maestros - LIMPIEZA
INSERT INTO price_master (id, code, category_id, subcategory, description, unit, labor_cost, material_cost, equipment_cost, other_cost, is_custom, user_id) VALUES
(gen_random_uuid(), '07-L-01', (SELECT id FROM price_categories WHERE name = 'LIMPIEZA'), 'LIMPIEZAS PERIÓDICAS DE OBRA', 'Mano de obra por la limpieza diaria/semanal de la obra.', 'Ud', 50.40, 50.40, 0, 0, false, NULL::uuid),
...
-- Insertar precios maestros - MATERIALES
INSERT INTO price_master (id, code, category_id, subcategory, description, unit, labor_cost, material_cost, equipment_cost, other_cost, is_custom, user_id) VALUES
...
CREATE POLICY "Ver precios maestros y propios" ON price_master
  FOR SELECT USING (
...
CREATE POLICY "Insertar historial propio" ON price_history
