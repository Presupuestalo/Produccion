...
async function simulatePublishFinal() {
    ...
    const country = "España" // RESTORED CANONICAL VALUE

    console.log(`--- Simulating Restored Notification Matching for ${email} ---`)
    console.log(`Criteria: Province=${province}, Country=${country}, Type=professional`)
    ...
    if (target) {
        console.log("✅ TARGET FOUND with restored values!")
        console.log(JSON.stringify(target, null, 2))
    } else {
        console.log("❌ TARGET NOT FOUND in matches with restored values")
