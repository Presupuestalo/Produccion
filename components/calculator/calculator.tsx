  ...
  const confirmRoomsImport = (dRooms?: Room[], rRooms?: Room[]) => {
    ...
    const processedDemolitionRooms = demolitionToProcess.map((room) => {
      ...
      return {
        ...
        floorMaterial: room.floorMaterial || ((isBathroomOrKitchen || isTerrace || room.removeFloor ? "Cerámica" : "Parquet flotante") as FloorMaterialType),
        ...
        lowerCeiling: room.lowerCeiling || room.falseCeiling || false,
